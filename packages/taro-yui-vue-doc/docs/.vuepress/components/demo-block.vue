...
export default {
    ...
    return {
      ...
      baseUrl:
        process.env.NODE_ENV === "development"
          ...
          : "https://ycmedia-dev.github.io/taro-yui-vue.demo",
      iframeHeight: 120,
    };
  },
  props: {
  ...
  mounted() {
    ...
    window.addEventListener("message", function (messageEvent) {
      ...
      if (typeof self.$refs[data.path] === undefined) {
        return;
      }
      console.log("message", messageEvent.data);
      if (data.path === self.url) {
        self.iframeHeight = data.height;
      }
    });
    this.$nextTick(() => {
